...
mkpath(joinpath(@__DIR__, "../images/ustar_observable"))
cfsite = 23
month = "01"
...
title!("ustar comparison (ρθq)")
xlabel!("T")
ylabel!("ustar")
png("images/ustar_observable/y_vs_model1")

theta_true = (4.7, 4.7, 15.0, 9.0)
model_truth = physical_model(theta_true, inputs, true)
plot(y, label="y")
plot!(model_truth, label="Model Truth")
title!("ustar comparison (pTq)")
xlabel!("T")
ylabel!("ustar")
png("images/ustar_observable/y_vs_model2")
