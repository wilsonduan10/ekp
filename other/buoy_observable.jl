# Using Buoyancy as an observable
# Imports
...
mkpath(joinpath(@__DIR__, "../images/buoy_observable"))
cfsite = 23
month = "01"
...
variance = 0.0
for x in buoyancy_flux_data
    global variance
    variance += (mean(buoyancy_flux_data) - x) * (mean(buoyancy_flux_data) - x)
end
variance /= T

Γ = variance * I
y = buoyancy_flux_data
...
xlabel!("T")
ylabel!("buoyancy")
png("images/buoy_observable/y_vs_model")
...
xlabel!("T")
ylabel!("buoyancy")
png("images/buoy_observable/model_comparison")
